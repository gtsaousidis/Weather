package com.projects.dfg_team.weather.Adapters;
...
/**
 * Created by georgetsd on 31/7/15.
 */
public class HourlyAdapter extends RecyclerView.Adapter<HourlyAdapter.HourViewHolder> {
    ...
    public class HourViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View v) {
            ...
            String temparture = mTemperatureLabel.getText().toString();

            String message = String.format("At %s it will be %s and %s",time, temparture, Summary);
